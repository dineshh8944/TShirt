...
const ViewDetials = () => {
    ...
    const {TopId,BestId,TopDay,PickId,BestSells,PickUp,CurrencyRupeeIcon,FilProductPick,setFilProductPick,FilProductTop,FilProductBest,setFilProductTop,setFilProductBest} = useContext(ShopContext);
...
//   <div>
//     <button
//       className={`Size-S ${selectedSize === 'S' ? 'selected' : ''}`}
//       onClick={() => handleSizeClick('S')}
//     >
//       S
//     </button>
//     <button
//       className={`Size-M ${selectedSize === 'M' ? 'selected' : ''}`}
//       onClick={() => handleSizeClick('M')}
//     >
//       M
//     </button>
//     <button
//       className={`Size-L ${selectedSize === 'L' ? 'selected' : ''}`}
//       onClick={() => handleSizeClick('L')}
//     >
//       L
//     </button>
//     <button
//       className={`Size-XL ${selectedSize === 'XL' ? 'selected' : ''}`}
