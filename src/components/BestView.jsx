...
const BestView = () => {
    const {BestId,BestSells,CurrencyRupeeIcon,FilProductBest,setFilProductBest} = useContext(ShopContext);
      ...
      {FilProductBest.map((pro)=> (
        ...
        <div className="right_1">
                    <ul>
                        ...
                        <li><p><span> Rs . {pro.Price}.00</span><span className='sales' >sale</span></p></li>
