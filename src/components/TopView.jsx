...
const TopView = () => {
    const {TheemsRef,TopId,TopDay,CurrencyRupeeIcon,FilProductTop,setFilProductTop,filteredAnime} = useContext(ShopContext);
    ...
    //  useEffect(() => {
    //             setFilProductTop(filteredAnime.filter((a) => a.id === TopId));
    ...
    //     }, [ TopId, filteredAnime ]);
       ...
       useEffect(() => {
                ...
                const dataAnimeOpen = TopDay.filter(item => item.id === TopId);
              
                // setFilProductTop(dataAnime);
               
                setFilProductTop(dataAnimeOpen); 
                // setFilProductTop(filteredAnime.filter((p) => p.id === TopId));
                 }, [ TopId ]);
        // }, [ TopId, TopDay, filteredAnime ]);
